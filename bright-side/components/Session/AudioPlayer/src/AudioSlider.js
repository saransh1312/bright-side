...
export default class AudioSlider extends PureComponent {
    ...
    constructor(props) {
        ...
        this._panResponder = PanResponder.create({
            ...
            onPanResponderMove: (e, gestureState)=> {
                ...
                ],{ useNativeDriver: true })(e, gestureState)
            },
    ...
    pause = async () => {
        ...
        Animated.timing(this.state.dotOffset,{ useNativeDriver: true }).stop(); // Will also call animationPausedOrStopped()
    }
    ...
    _onPlaybackStatusUpdate = playbackStatus => {
        if (!playbackStatus.isLoaded) {
          ...
          if (playbackStatus.didJustFinish && !playbackStatus.isLooping) {
            this.props.setPlaybackFinishSignal(true);
          }
        }
      };
